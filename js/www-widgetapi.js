(function() {
    ...
    function w(a, b, c) {
        Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? w = ca : w = ea;
    ...
    function ia(a, b) {
        a: {
            var c = a.length;
            for (var d = m(a) ? a.split("") : a, e = 0; e < c; e++)
    ...
    function Aa(a) {
        var b = new F;
        b.a = E instanceof D && E.constructor === D && E.b === oa ? E.a : "type_error:Const";
        a.src = (b instanceof F && b.constructor === F && b.b === pa ? b.a : "type_error:TrustedResourceUrl").toString()
    };
    ...
    function Ca() {
        ...
        "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == G.indexOf("Presto") && (a = function() {
            ...
            e = f.document;
            e.open();
            e.write(J instanceof H && J.constructor === H && J.b === za ? J.a : "type_error:SafeHtml");
            e.close();
    ...
    function Fa() {
        if (l.Promise && l.Promise.resolve) {
            ...
            var b = Ia,
                c;
            !(c = "function" != q(l.setImmediate)) && (c = l.Window && l.Window.prototype) && (c = -1 == G.indexOf("Edge") && l.Window.prototype.setImmediate == l.setImmediate);
            c ? (K || (K = Ca()), K(b)) : l.setImmediate(b)
        }
    }
    var Ga = !1,
        Ha = new L;
    ...
    function Ja(a, b) {
        ...
        if (a) {
            ...
            for (c = d = 0; e = f[c]; c++) {
                var h = e.className,
                    p;
                if (p = "function" == typeof h.split) p = 0 <= ha(h.split(/\s+/), a);
                p && (g[d++] = e)
            }
            g.length = d;
            return g
    ...
    k.D = function(a) {
        ...
        if (b) {
            var c = this.b[b];
            if (0 != this.i) this.h.push(a), this.a[a + 1] = aa;
            else {
                if (c) {
                    var d = ha(c, a);
    ...
    k.clear = function(a) {
        if (a) {
            var b = this.b[a];
            b && (z(b, this.D, this), delete this.b[a])
    ...
    function Va(a, b) {
        ...
        c ? c(a, b, void 0, void 0, void 0) : (c = [], c = "ERRORS" in R ? R.ERRORS : c, c.push([a, b, void 0, void 0, void 0]), Ta("ERRORS", c))
    };
    var Wa = 0;
    x("ytDomDomGetNextId", n("ytDomDomGetNextId") || function() {
        return ++Wa
    });
    var Xa = {
    ...
    function S(a) {
        ...
        for (var b in a) b in Xa || (this[b] = a[b]);
    ...
    var C = n("ytEventsEventsListeners") || {};
    x("ytEventsEventsListeners", C);
    var Ya = n("ytEventsEventsCounter") || {
        count: 0
    };
    x("ytEventsEventsCounter", Ya);
    ...
    function $a(a) {
        a && ("string" == typeof a && (a = [a]), z(a, function(b) {
            if (b in C) {
                var c = C[b],
                    d = c[0],
                    e = c[1],
                    f = c[3];
                c = c[4];
                d.removeEventListener ? ab() || "boolean" == typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete C[b]
            }
        }))
    }
    ...
    function bb(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var g = f ? function(h) {
                    h = new S(h);
                    if (!Ka(h.relatedTarget, function(p) {
                            return p == a
                ...
                g = Ua(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), ab() || "boolean" == typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                C[e] = [a, b, c, g, d]
            }
        }
    };
    ...
    function eb(a) {
        return db[a] || (db[a] = String(a).replace(/\-([a-z])/g, function(b, c) {
    ...
    function ib(a, b) {
        b || (b = document);
        var c = ka(b.getElementsByTagName("yt:" + a)),
            d = "yt-" + a,
            e = b || document;
        d = ka(e.querySelectorAll && e.querySelector ? e.querySelectorAll("." + d) : Ja(d, b));
        return ja(c, d)
    }

    function U(a, b) {
        var c;
        "yt:" == a.tagName.toLowerCase().substr(0, 3) ? c = a.getAttribute(b) : c = a ? a.dataset ? a.dataset[eb(b)] : a.getAttribute("data-" + b) : null;
        return c
    }

    function jb(a, b) {
        Q.H.apply(Q, arguments)
    };
    ...
    kb.prototype.g = function(a) {
        if (a.origin == W(this, "host") || a.origin == W(this, "host").replace(/^http:/, "https:")) {
            ...
            if (a = V[b.id]) a.B = !0, a.B && (z(a.u, a.C, a), a.u.length = 0), a.I(b)
        }
    };

    function X(a, b, c) {
        this.i = this.a = this.b = null;
        this.h = this[v] || (this[v] = ++ba);
        this.f = 0;
        this.B = !1;
        this.u = [];
        this.g = null;
        ...
        this.o = {};
        c = document;
        if (a = m(a) ? c.getElementById(a) : a)
            if (c = "iframe" == a.tagName.toLowerCase(), b.host || (b.host = c ? Pa(a.src) : "https://www.youtube.com"), this.b = new kb(b), c || (b = mb(this, a), this.i = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.a = a, this.a.id || (a = b = this.a, a = a[v] || (a[v] = ++ba), b.id = "widget" + a), T[this.a.id] = this, window.postMessage) {
                this.g = new P;
                nb(this);
                b = W(this.b, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in gb) ob(this, e)
            }
    }
    k = X.prototype;
    ...
    function mb(a, b) {
        ...
        h.widgetid = a.h;
        window.location.href && z(["debugjs", "debugcss"], function(p) {
            var u = window.location.href;
            var da = u.search(Sa);
            b: {
                var r = 0;
                for (var A = p.length; 0 <= (r = u.indexOf(p, r)) && r < da;) {
    ...
    function nb(a) {
        lb(a.b, a, a.h);
        a.f = cb(w(a.G, a));
        bb(a.a, "load", w(function() {
            window.clearInterval(this.f);
            this.f = cb(w(this.G, this))
        }, a))
    }

    function pb(a, b) {
        a.o[b] || (a.o[b] = !0, qb(a, "addEventListener", [b]))
    }
    k.C = function(a) {
        a.id = this.h;
        a.channel = "widget";
        ...
        if (this.a.contentWindow)
            for (c = 0; c < b.length; c++) try {
                ...
                if (d.name && "SyntaxError" == d.name) Va(d, "WARNING");
                else throw d;
        ...
        z(b, function(c) {
            this[c] || ("getCurrentTime" == c ? this[c] = function() {
                ...
                if (1 == this.l.playerState) {
                    var e = (fa() / 1E3 - this.l.currentTimeLastUpdated_) * this.l.playbackRate;
                    0 < e && (d += Math.min(e, 1))
                }
                return d
            } : rb(c) ? this[c] = function() {
                this.l = {};
                this.j = {};
                qb(this, c, arguments);
                return this
            } : sb(c) ? this[c] = function() {
                var d = 0;
    ...
    k.getVideoEmbedCode = function() {
        ...
        var b = parseInt(W(this.b, "height"), 10),
            c = W(this.b, "host") + this.w();
        wa.test(c) && (-1 != c.indexOf("&") && (c = c.replace(qa, "&amp;")), -1 != c.indexOf("<") && (c = c.replace(ra, "&lt;")), -1 != c.indexOf(">") && (c = c.replace(sa, "&gt;")), -1 != c.indexOf('"') && (c = c.replace(ta, "&quot;")), -1 != c.indexOf("'") && (c = c.replace(ua, "&#39;")), -1 != c.indexOf("\x00") && (c = c.replace(va, "&#0;")));
    ...
    x("YT.PlayerState.UNSTARTED", -1);
    x("YT.PlayerState.ENDED", 0);
    x("YT.PlayerState.PLAYING", 1);
    x("YT.PlayerState.PAUSED", 2);
    x("YT.PlayerState.BUFFERING", 3);
    x("YT.PlayerState.CUED", 5);
    x("YT.get", function(a) {
        return T[a]
    });
    x("YT.scan", hb);
    x("YT.subscribe", function(a, b, c) {
        Q.subscribe(a, b, c);
        gb[a] = !0;
        for (var d in T) ob(T[d], a)
    });
    x("YT.unsubscribe", function(a, b, c) {
        Ma(a, b, c)
    });
    x("YT.Player", Y);
    x("YT.Thumbnail", Z);
    ...
    X.prototype.getIframe = X.prototype.K;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || hb();
    var xb = n("onYTReady");
    xb && xb();
    var yb = n("onYouTubeIframeAPIReady");
    yb && yb();
    var zb = n("onYouTubePlayerAPIReady");
    zb && zb();
}).call(this);